...
from .views import RegisterView,LogoutView,VerifyEmailView,ProfileView,ForgotPasswordView,PasswordResetView,AssignRoleView
import os
...
urlpatterns = [
    ...
    path('assign-role/', ForgotPasswordView.as_view() ,name="assign-role"),
